...
SQLite fresh、从 027 升级到 034、重复启动幂等均由自动化测试覆盖。PostgreSQL 本地 migration contract 覆盖 027、035–042；033/041 为 baseline 事件补充正规化 scope 列和复合索引，034/042 增加 preview owner fencing 与 canonical shard content hash，均不修改旧迁移。在没有受控 PostgreSQL 实例时，只能报告“未执行 live DDL”。
