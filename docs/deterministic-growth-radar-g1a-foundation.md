...
> 后续口径：G1A.5 已收到并验证真实订单与库存文件。库存范围、`SKU + 仓库` 关联、销售指标分层和 G1B 结论以 `docs/deterministic-growth-radar-g1a5-scope-and-linkage.md` 为准；本文第 15、23、25、26 节保留为 G1A 当时的历史状态。
