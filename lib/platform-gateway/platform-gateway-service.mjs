...
const OPERATION_METHODS = Object.freeze({
  ...
  get_finance_transactions: "getFinanceTransactions",
  get_expense_transactions: "getExpenseTransactions",
...
export class CommercePlatformGatewayService {
  ...
  getFinanceTransactions(input) { return this.#execute("get_finance_transactions", input); }
  getExpenseTransactions(input) { return this.#execute("get_expense_transactions", input); }
  ...
  async #execute(operation, input = {}) {
    ...
    try {
      ...
      const authorizationMode = typeof this.registry.authorizationMode === "function"
        ? this.registry.authorizationMode(platform.type)
        : "required";
      const authorization = authorizationMode === "delegated"
        ? null
        : await this.#authorizationFor(platform, shop, operation);
      const connector = this.registry.create(platform.type, { platform, shop, authorization });
