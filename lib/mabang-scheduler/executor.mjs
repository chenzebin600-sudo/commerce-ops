...
export function createTaskExecutor({ db, runWorker, exportRoot, tempRoot = path.join(exportRoot, ".temp"), notify = sendDingtalkMessage, retryDelays = retryDelaysFromEnv(), now = () => new Date() }) {
