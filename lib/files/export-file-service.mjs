...
export class ExportFileService {
  ...
  async persistTemporaryExport(input) {
    ...
    try {
      ...
      auditFile(this.audit, input.sourceType === "product_package_import" ? "file.upload" : "file.export.created", file);
      ...
      auditFile(this.audit, input.sourceType === "product_package_import" ? "file.upload.rejected" : "file.export.failed", pending, {
        status: "failed",
        sourceType: input.sourceType,
