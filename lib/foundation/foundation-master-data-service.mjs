...
import { SOURCE_SYSTEM_VALUES } from "../data-foundation/unified-data-contracts.mjs";

function canonicalSourceSystem(value, fallback = SOURCE_SYSTEM_VALUES.PRODUCT_PACKAGE) {
  ...
  return [
    ...
    SOURCE_SYSTEM_VALUES.PRODUCT_PACKAGE,
    "commerce_ops",
