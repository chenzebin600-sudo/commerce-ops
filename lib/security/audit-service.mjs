...
export class OperationAuditService {
  ...
  recordAuditEvent(input = {}) {
    ...
    return serializeRow(this.repository.create({
      id,
      requestId,
  ...
  getEvent(id) {
    return serializeRow(this.repository.get(String(id || "")));
  }
  ...
  queryEvents(filters = {}) {
    ...
    const { rows, total } = this.repository.query({
      ...normalized,
  ...
  summary({ start, end } = {}) {
    ...
    const { byStatus, byModule } = this.repository.summary({
