export const PRODUCT_AI_PROMPT_VERSION = "product-selling-points-v2";
...
export function buildProductAiMessages({ context, options }) {
  const systemPrompt = [
    ...
    "JSON 必须包含 product_summary、title_suggestions、description_suggestion、target_users、user_pain_points、selling_points、usage_scenarios、feature_benefit_map、risk_notes。",
    "title_suggestions 必须是可人工选择的标题数组；description_suggestion 必须是基于产品事实的商品描述建议。",
